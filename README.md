...
- Locations: original interactive Doskvol cartography based on the core-book district geography, with zooming, district dossiers, faction and campaign layers, score opportunities, custom saved locations and district notes
